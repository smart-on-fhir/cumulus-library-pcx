...
| [elastic_query](cumulus_library_pcx/elastic_query.toml)                     | (optional) find more patient cases using full text search (requires server and client [rapid-elastic](https://github.com/smart-on-fhir/rapid-elastic)). See [query_topics.md](query_topics.md) for PCX variable full-text search. | 
