...
class PcxNlpSurvivalTimelineWideBuilder(
    PcxLLMBaseMixin,
    cumulus_library.BaseTableBuilder,
    task_display="Patient Timeline",
    task_tabular_display="survival_timeline",
    task_table_suffix="wide",
):
    """pcx__llm_survival_timeline_wide: one row per note, flattening the scalar mention(s)
    vital_status.
    """
