...
class CancerPredispositionMention(SpanAugmentedMention):
    ...
    status: PredispositionStatus = Field(default=PredispositionStatus.UNEVALUATED, description="PRESENT: pathogenic/likely pathogenic germline finding or diagnosed syndrome. ABSENT: only for explicitly negative testing. UNCERTAIN: VUS, never PRESENT. UNEVALUATED: missing testing.")
