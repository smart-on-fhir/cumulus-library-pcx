...
| `pcx__nlp_<task>_<deployment>`      | llm_clinical_wide                                                | raw LLM output tables written by the NLP stages                      |
...
| [llm_document_wide](cumulus_library_pcx/llm_document_wide.toml)   | on    | LLM -> SQL: document type and topic-routing results, generated by [llm_document_wide.py](cumulus_library_pcx/stage/llm_document_wide.py)                                                                                                     |
| [llm_clinical_wide](cumulus_library_pcx/llm_clinical_wide.toml)   | on    | LLM -> SQL: 21 clinical projections generated by [llm_clinical_wide.py](cumulus_library_pcx/stage/llm_clinical_wide.py). Selected NLP source tables must exist. See [llm.md](llm.md#schema-generation-and-wide-outputs) |
