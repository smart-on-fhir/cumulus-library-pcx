...
| [elastic_output](cumulus_library_pcx/elastic_output.toml)                       | skip  | (optional) load elastic search results into SQL. Currently points at an upload manifest outside the repo, which breaks manifest loading (1.2)                                                                                                             |
