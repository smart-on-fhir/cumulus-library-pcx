...
| `pcx__nlp_<task>_<deployment>`      | nlp_wide_clinical                                                | raw LLM output tables written by the NLP stages                      |
...
| [nlp_wide_document](cumulus_library_pcx/nlp_wide_document.toml)   | on    | LLM -> SQL: document type and topic-routing results, generated by [nlp_wide_document.py](cumulus_library_pcx/stage/nlp_wide_document.py)                                                                                                     |
| [nlp_wide_clinical](cumulus_library_pcx/nlp_wide_clinical.toml)   | on    | LLM -> SQL: 21 clinical projections generated by [nlp_wide_clinical.py](cumulus_library_pcx/stage/nlp_wide_clinical.py). Selected NLP source tables must exist. See [llm.md](llm.md#schema-generation-and-wide-outputs) |
