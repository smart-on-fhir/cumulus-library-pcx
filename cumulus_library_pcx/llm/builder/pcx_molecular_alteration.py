...
class PcxNlpMolecularAlterationBuilder(
    PcxLLMBaseMixin,
    cumulus_library.BaseTableBuilder,
    task_display="Molecular",
    task_tabular_display="molecular",
    task_table_suffix="alteration",
):
    """pcx__llm_molecular_alteration: one row per MolecularAlterationMention
    in result.alterations.

    alteration_index: 1-based list position(s) from UNNEST WITH ORDINALITY,
