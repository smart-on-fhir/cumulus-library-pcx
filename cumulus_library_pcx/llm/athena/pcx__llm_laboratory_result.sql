...
SELECT  DISTINCT
        ...
        result_index,
        result.test                                                  AS test,
        result.value_numeric                                         AS value_numeric,
        result.value_type                                            AS value_type,
        result.value_unit                                            AS value_unit,
        result.trend                                                 AS trend,
        result.interp_instrument                                     AS interp_instrument,
        result.interp_clinician                                      AS interp_clinician,
        result.interp_llm                                            AS interp_llm,
